          ...
          <div className="flex flex-col md:flex-row md:gap-6">
            ...
            <div className="w-12/12 md:w-7/12 xl:w-5/12">
              ...
              <div className="flex flex-col gap-4">
                <p>
                  Bienvenue ! Je m'appelle Antoine, j'ai 27 ans et je suis
                  passionné par le monde du web et le développement en général
                  et cela depuis 2015.
                </p>
                <p>
                  Je travaille la plupart du temps avec React.js et j'aime créer
                  des interfaces plaisantes, compréhensibles et performantes
                ...
                <p>
                  ...
                  l'accessibilité numérique, un enjeu que je trouve bien trop
                  souvent sous-estimé par les acteurs du numérique.
                </p>
                <p>
